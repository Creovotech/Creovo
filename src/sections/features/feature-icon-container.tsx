...
export const FeatureIconContainer = ({
  ...
  return (
    <div className=" perspective-[400px] transform-3d">
      <div
        className={cn(
          'h-14 w-12 p-1 bg-linear-to-b from-neutral-800  to-neutral-950 mx-auto relative scale-110'
        )}
        style={{
      ...
      >
        ...
        <div className="absolute bottom-0 inset-x-0 bg-linear-to-r from-transparent via-neutral-600 blur-xs to-transparent h-2 w-[60%] mx-auto"></div>
      </div>
    </div>
  );
};