...
export const FEATURES_ITEMS = {
  heading: "Engineering for Global Scale",
  sub_heading:
    "From local startups to global ecosystems, we architect solutions designed to handle millions of interactions without breaking a sweat.",
  cards: {
    globe: {
      title: "Built for Global Scale",
      description:
        "We deploy across regions on infrastructure designed to serve users worldwide with low latency and high availability.",
    },
    ray: {
      title: "From Prototype to Production",
      description:
        "Architecture that grows with you — start lean and scale to millions of users without painful rewrites.",
    },
    graph: {
      title: "Agentic & AI-Native",
      description:
        "We build intelligent agents and conversational systems, rigorously tested for hallucinations, edge cases, and logical consistency.",
    },
    social: {
      title: "Seamless Integrations",
      description:
        "Connect the platforms and tools your business already runs on, from social channels to internal systems.",
    },
  },
};
  ...
  launches: [
    {
      ...
      description:
        "It starts with a deep-dive consultation. We don't just ask what features you want; we analyze the business problem you're solving. Whether it's a web platform or an autonomous agent, we define the technical feasibility, scope, and success metrics before writing a single line of code.",
