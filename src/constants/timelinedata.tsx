    ...
    content: (
      <div>
        <p className="mb-4 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
          The launch is just the beginning of our journey together. We conduct rigorous testing across all devices to ensure a seamless rollout. Post-launch, we monitor performance, gather user data, and provide ongoing support to optimize and scale your platform for future growth.
        </p>
        <div className="mb-8">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ Seamless Deployment & Go-Live Strategy
          </div>
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-700 md:text-sm dark:text-neutral-300">
            ✅ SEO & Growth Strategy Implementation
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <img
