  ...
  launches: [
    {
      ...
      description:
        "Successfully launched our very first client website, marking the official beginning of our journey to build exceptional digital experiences.",
      mission_number: "01",
    },
    {
      title: "Expanding Our Services",
      description:
        "Ventured beyond web development by delivering our first mobile app and integrating custom AI agents, broadening our technical expertise.",
      mission_number: "02",
    },
    {
      title: "50+ Projects Delivered",
      description:
        "A major milestone celebrating the successful delivery of over 50 projects for clients across diverse industries, from innovative startups to established enterprises.",
      mission_number: "03",
    }
  ],
};
